...
- [API Tiers](#api-tiers)
  - [Tier 1 — Private (`__double_underscore, Mixed Case`)](#tier-1-private-__double_underscore-mixed-case)
  - [Tier 2 — Semi-Private (`_single_underscore`)](#tier-2-semi-private-_single_underscore)
  - [Tier 3 — Public (`ClassName.method`)](#tier-3-public-classnamemethod)
- [Comments](#comments)
  - [Function Headers](#function-headers)
  - [Inline Comments](#inline-comments)
  - [Trailing Inline Comments](#trailing-inline-comments)
  - [Comment Maintenance](#comment-maintenance)
- [Variable Naming](#variable-naming)
  - [Local Variables](#local-variables)
  - [Framework Globals](#framework-globals)
  - [Inherited Identity Variables](#inherited-identity-variables)
  - [User-Facing Variables](#user-facing-variables)
- [Output](#output)
  - [`printf`, Never `echo`](#printf-never-echo)
  - [Characters and Encoding](#characters-and-encoding)
  - [Value Returns](#value-returns)
- [Shell Options](#shell-options)
  - [errexit Safety (`set -e`)](#errexit-safety-set--e)
  - [IFS Independence](#ifs-independence)
  - [nounset Safety (`set -u`)](#nounset-safety-set--u)
  - [Framework Must Not Alter User Environment](#framework-must-not-alter-user-environment)
- [Error Handling](#error-handling)
  - [The Two Error Paths: `_Crash` vs `_Error` + return 1](#the-two-error-paths-_crash-vs-_error-return-1)
  - [Tier-Appropriate Validation](#tier-appropriate-validation)
  - [`2>/dev/null` Policy](#2devnull-policy)
- [Class File Structure](#class-file-structure)
- [API Shape](#api-shape)
  - [Primitives Inward, Wrappers Outward](#primitives-inward-wrappers-outward)
  - [Cost of an I/O Round-Trip](#cost-of-an-io-round-trip)
- [Liskov Substitution Principle (LSP)](#liskov-substitution-principle-lsp)
  - [When to Diverge](#when-to-diverge)
- [Test Files](#test-files)
  - [Naming](#naming)
  - [Zero-Fork Where Possible](#zero-fork-where-possible)
  - [Verbosity](#verbosity)
- [Refactoring Policy](#refactoring-policy)
  - [Sanitize on Sight](#sanitize-on-sight)
  - [Don't Break the Tests](#dont-break-the-tests)
- [Class Variant Conventions (`::Simple` and `::Fast`)](#class-variant-conventions-simple-and-fast)
  - [`Class::Simple`](#classsimple)
  - [`Class::Fast`](#classfast)
  - [What the convention is NOT](#what-the-convention-is-not)
- [Class Properties (static/instance)](#class-properties-staticinstance)
- [Constructor Preamble: `into=` Guard](#constructor-preamble-into-guard)
